<template>
  <div>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <AppBreadcrumb :items="[{ label: 'Models' }, { label: 'Forms', to: backTo }, { label: isEdit ? (form.name || 'Edit Form') : 'New Form' }]" />
        </div>
...
const backTo = computed(() => route.query.status === 'inactive' ? '/forms?status=inactive' : '/forms')
